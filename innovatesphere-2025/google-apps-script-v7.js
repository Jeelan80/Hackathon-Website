...
// Deploy this as a Web App to receive form submissions - Version 7
...
function doPost(e) {
  ...
  try {
    ...
    const rowData = [
      new Date().toISOString(), // Current timestamp instead of relying on submitted time
      data.firstName || '',
      data.lastName || '',
      data.email || '',
      data.phone || '',
      ...
      data.teamName || '',
      data.teamSize || '',
      data.teamMember2FirstName || data.teamMember2?.firstName || '',
      data.teamMember2LastName || data.teamMember2?.lastName || '',
      data.teamMember2Email || data.teamMember2?.email || '',
      data.teamMember2Phone || data.teamMember2?.phone || '',
      data.teamMember2Institution || data.teamMember2?.institution || '',
      data.teamMember2Degree || data.teamMember2?.degree || '',
      data.teamMember2GraduationYear || data.teamMember2?.graduationYear || '',
      data.teamMember3FirstName || data.teamMember3?.firstName || '',
      data.teamMember3LastName || data.teamMember3?.lastName || '',
      data.teamMember3Email || data.teamMember3?.email || '',
      data.teamMember3Phone || data.teamMember3?.phone || '',
      data.teamMember3Institution || data.teamMember3?.institution || '',
      data.teamMember3Degree || data.teamMember3?.degree || '',
      data.teamMember3GraduationYear || data.teamMember3?.graduationYear || '',
